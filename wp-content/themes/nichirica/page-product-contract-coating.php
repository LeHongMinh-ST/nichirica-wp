...
<?php get_template_part('template-parts/banners/banner-no-image')?>
  ...
  <div class="products_detail size contract-coating">
    ...
    <div class="section-content products_detail__content">
      <img src="<?=THEME_URI?>/assets/images/contract-coating.png" alt="">
      <p>
        原料投入からの塗料調合、コンセプト提案の塗料共同開発、水系非クリーンコーター～溶剤系クリーンコーターを用いた幅広い領域のコーティング、各種スリッター、加工機を用いたテープ化、ラベル化、シート化など様々なご要望にお答えします。お気軽にお問い合わせページからご連絡ください。
      </p>
    </div>
  </div>
