...
<div class="read-together">
  ...
  <div class="about size">
    <div class="section-content about--list">
      <?php if ($current_page_slug != 'about-message') { ?>
      ...
      <?php } ?>
      <?php if ($current_page_slug != 'about-profile') { ?>
      <div class="about--item">
      ...
      <?php } ?>
      <?php if ($current_page_slug != 'about-offices') { ?>
      <div class="about--item">
      ...
      <?php } ?>
      <?php if ($current_page_slug != 'about-environmental-policy') { ?>
      <div class="about--item">
